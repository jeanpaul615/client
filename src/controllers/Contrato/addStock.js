...
export const submitContrato = async (Nombre_contrato, Nombre_material, Nombre_tecnico, Cantidad, onClose) => {
  try {
    const response = await axios.post('http://3.136.228.49:8001/contrato/add-contratos', {
      Nombre_contrato,
      Nombre_tecnico,
      Nombre_material,
      Cantidad,
    ...
    const response2 = await axios.put('http://3.136.228.49:8001/stocktechnique/update-cantidad-stocktechnique', {
      Nombre_material,
      Nombre_tecnico,
      Cantidad,
    });
